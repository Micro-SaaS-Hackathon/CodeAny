    ...
    <div class="grid grid-cols-[220px_1fr]">
      <aside class="border-r border-default min-h-[calc(100vh-3.5rem)]">
        <nav class="p-2 space-y-1">
          <NuxtLink to="/app/dashboard" class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
            <UIcon name="i-lucide-home" />
            <span>Dashboard</span>
          </NuxtLink>
          <NuxtLink to="/app/courses/list" class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
